...
- **Fixed.** Music requests never downloaded: the default "Lossless" profile rejected every MP3 and unlabelled release that public sources have. New default is a "Best available" profile that accepts everything but trash and keeps upgrading toward lossless (mono and low-bitrate rips stay blocked). **Upgrade:** setup adds the profile; existing artists keep the profile they had, change it under the artist's quality setting.
