...
- **Fixed.** Music requests never downloaded: the default "Lossless" profile rejected every MP3 and unlabelled release that public sources have. Music now defaults to the "Standard" profile (good-quality MP3/AAC/OGG), movies and TV to HD-1080p. A "Best available" profile (everything but trash, upgrades toward lossless) is added for anyone who wants more sources. Existing titles keep their profile; change it under the title's quality setting or the default under Settings.
