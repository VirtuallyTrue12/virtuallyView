...
export const ART_HOST = /^(images\.lidarr\.audio|coverartarchive\.org|(?:[\w-]+\.)?archive\.org|assets\.fanart\.tv|fanart\.tv|upload\.wikimedia\.org|image\.tmdb\.org|artworks\.thetvdb\.com)$/i;
